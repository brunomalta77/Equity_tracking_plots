...
def check_awareness_high_level(eq, df, brand,time_period, period_pre, period_start, period_end):
    ...
    def highlight_row_during(x):
        if x.name == 0:  # Highlight the row with index 2
            ...
            return ['background-color: #FA8072'] * len(x)
...
#----------------------------------------------------------------------------------------------// Logout //------------------------------------------------------------------------------------------------ 
                  ...
                  with st.sidebar:
                          ...
                          # reading the equity file
                           ...
                           df_significance = pd.read_excel(filepath_equity,sheet_name="significance")
                           df_perc_changes = pd.read_excel(filepath_equity,sheet_name="perc_changes")
